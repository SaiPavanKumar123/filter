...
<%@ page import="java.util.*,loanmanagement.*,java.text.DecimalFormat" %>
<% List<LoanEMISchedule> appList = (List<LoanEMISchedule>)request.getAttribute("emischedule"); %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="content"> <div></div><br><br>
        ...
        <table>
            ...
            <% if(appList!=null){for (LoanEMISchedule loan : appList) { %>
                <tr>
                    <td><%= loan.getApplicantid() %></td>
                    <td><%= loan.getEmiIndex() %></td>
                    <td><%= loan.getEmiDate() %></td>
                    
                    <td><%= loan.getEmiAmount() %></td>
                    <td>upcoming</td>
